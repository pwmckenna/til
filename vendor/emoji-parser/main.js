...
(function(root, factory) {
  if (typeof exports === 'object') {
    ...
    return define('emoji-parser', function() {
      return root.emojiParser = factory();
    });
  } else {
    return root.emojiParser = factory();
  }
  ...
  var service;
  service = function(text, url, options) {
    var classes, list;
    if (options == null) {
      options = {};
    }
    ...
    classes = options.classes != null ? options.classes : DEFAULT_CLASSES;
    return text.replace(TEST_REGEX, function(match, name, parameter) {
      if (list.indexOf(name) === -1) {
        return match;
      } else {
        return options.parser([match, name, parameter], url, classes, options);
      }
    });
  };
